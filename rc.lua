...
beautiful.init("/home/morn/.config/awesome/themes/wombat/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "www", "irc", "office", "misc", 5, 6, 7, 8}, s, layouts[1])
end
-- }}}
...
memicon:set_image(awful.util.getdir("config") .. "/icons/mem.png")
-- Initialize widget
...
cpugraph:set_background_color("#003F3F3F")
